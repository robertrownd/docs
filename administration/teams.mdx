...
title: "Teams"
description:
  "Give team members access to co-manage aspects of your Airmen Data Platform account."
---

#### Inviting new team members

First, sign into your Airmen Data Platform account, click on the dropdown menu on the top right
...
- **Owner:** Can add applications, edit data types, and add integrations (data sources)

- **Admin:** Limited control over apps.  Can add team members

- **Editor:** Cannot invite team members or
  modify account settings.  Can create an API key and secret. 
...
containing a link that will automatically sign them into Airmen Data Platform and prompt them
