...
description:
  "Airmen Data Platform applications connect to your product(s) to provide Airmen Data Platform authentication
  to your users."
---

Application in this context, contains a unique code snippet that, when injected across
your product, provides user authentication to your platform. Within your Airmen Data Platform
application, you can define and customize data types, and more. You can also connect a Airmen Data Platform application to your existing tools with
Integrations. It is likely that one Airmen Data Platform application is enough to span all
aspects of your product, but you can create multiple Airmen Data Platform apps in your account
...
### Edit an application (Only Owners can edit an application)

Airmen Data Platform creates a sample application during initial account setup. You can edit it to suit your needs.
...
If you have multiple Airmen Data Platform applications, you can switch between them using the application switcher.
...
<Warning>
Deleting your Airmen Data Platform application completely removes all application data from
Airmen Data Platform. If the application is being used to authenticate users in your product,
