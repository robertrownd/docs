...
The Rownd SDK for Android provides simple account and user profile management, deep linking, encryption and more for native Android applications.

Using the BESPIN Airmen Data Platform platform, you can easily bring the same goverance that's on your website to your mobile apps. Or if you only authenticate users on your mobile apps, you can streamline the goverance process using Rownd's passwordless sign-in links, enabling you to seamlessly authenticate users from an app link sent to their email or phone number.
...
Rownd.config.apiUrl = "https://api.dev.rownd.teambespin.us"
Rownd.config.baseUrl = "https://hub.dev.rownd.teambespin.us"
```
...
While most customizations are handled via the [Rownd dashboard](https://https://app.dev.rownd.teambespin.us), there are a few things that have to be customized directly in the SDK.
